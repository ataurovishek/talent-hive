            ...
            <Card className="hover:shadow-lg transition-all duration-300 hover:border-primary">
                <CardHeader>
                    <div className="flex flex-col md:flex-row gap-4">
                        <Image src={job.Company.logo} alt={job.Company.name} width={48} height={48} className="size-14 rounded-lg" />
                    ...
                    <p className="text-base text-muted-foreground line-clamp-3 pt-2">
                        {job.Company.about}
                    </p>
                </CardHeader>
            </Card>
