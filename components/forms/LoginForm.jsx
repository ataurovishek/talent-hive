...
export async function LoginForm() {
    ...
    return (
        ...
        <div className="flex flex-col gap-6">
            ...
            <Card className="px-16 border-black dark:border-gray-700">
                ...
                <CardContent>
                    ...
                    <div className="flex flex-col gap-4 dark:border-white">
